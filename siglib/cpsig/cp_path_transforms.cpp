...
extern "C" {
	...
	CPSIG_API int transform_path_float(const float* data_in, float* data_out, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, float end_time) noexcept {
	...
	CPSIG_API int batch_transform_path_float(const float* data_in, float* data_out, uint64_t batch_size, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, float end_time, int n_jobs) noexcept {
	...
	CPSIG_API int transform_path_backprop_float(const float* derivs, float* data_out, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, float end_time) noexcept {
		SAFE_CALL(transform_path_backprop_<float>(derivs, data_out, dimension, length, time_aug, lead_lag, end_time));
	}

	CPSIG_API int transform_path_backprop_double(const double* derivs, double* data_out, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, double end_time) noexcept {
		SAFE_CALL(transform_path_backprop_<double>(derivs, data_out, dimension, length, time_aug, lead_lag, end_time));
	}

	CPSIG_API int batch_transform_path_backprop_float(const float* derivs, float* data_out, uint64_t batch_size, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, float end_time, int n_jobs) noexcept {
	...
	CPSIG_API int batch_transform_path_backprop_double(const double* derivs, double* data_out, uint64_t batch_size, uint64_t dimension, uint64_t length, bool time_aug, bool lead_lag, double end_time, int n_jobs) noexcept {
