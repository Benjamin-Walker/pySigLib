...
def prepare_log_sig(
    ...
    """
    Prepares for log signature computations. For details,
...
def reset_log_sig() -> Union[np.ndarray, torch.tensor]:
    """
    Clears the cache generated by ``pysiglib.prepare_log_sig``. It is only
    necessary to call this function if multiple different parameter combinations
