...
CPSIG.transform_path_backprop_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    c_uint64,
    c_uint64,
...
CPSIG.transform_path_backprop_float.restype = c_int

CPSIG.transform_path_backprop_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    c_uint64,
    c_uint64,
...
CPSIG.transform_path_backprop_double.restype = c_int

######################################################
# batch_transform_path_backprop
######################################################

CPSIG.batch_transform_path_backprop_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    c_uint64,
    c_uint64,
...
CPSIG.batch_transform_path_backprop_float.restype = c_int

CPSIG.batch_transform_path_backprop_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    c_uint64,
    c_uint64,
...
CPSIG.batch_transform_path_backprop_double.restype = c_int
...
if BUILT_WITH_CUDA:
    ...
    CUSIG.transform_path_backprop_cuda_float.argtypes = (
        POINTER(c_float),
        POINTER(c_float),
        c_uint64,
        c_uint64,
    ...
    CUSIG.transform_path_backprop_cuda_float.restype = c_int

    CUSIG.transform_path_backprop_cuda_double.argtypes = (
        POINTER(c_double),
        POINTER(c_double),
        c_uint64,
        c_uint64,
    ...
    CUSIG.transform_path_backprop_cuda_double.restype = c_int

    ######################################################
    # batch_transform_path_backprop_cuda
    ######################################################

    CUSIG.batch_transform_path_backprop_cuda_float.argtypes = (
        POINTER(c_float),
        POINTER(c_float),
        c_uint64,
        c_uint64,
    ...
    CUSIG.batch_transform_path_backprop_cuda_float.restype = c_int

    CUSIG.batch_transform_path_backprop_cuda_double.argtypes = (
        POINTER(c_double),
        POINTER(c_double),
        c_uint64,
        c_uint64,
    ...
    CUSIG.batch_transform_path_backprop_cuda_double.restype = c_int
...
CPSIG.sig_combine_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
    c_uint64,
...
CPSIG.sig_combine_float.restype = c_int

CPSIG.sig_combine_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
    c_uint64,
...
CPSIG.sig_combine_double.restype = c_int

######################################################
# batch_sig_combine
######################################################

CPSIG.batch_sig_combine_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
    c_uint64,
...
CPSIG.batch_sig_combine_float.restype = c_int

CPSIG.batch_sig_combine_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
    c_uint64,
...
CPSIG.batch_sig_combine_double.restype = c_int

######################################################
# sig_combine_backprop
######################################################

CPSIG.sig_combine_backprop_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
...
CPSIG.sig_combine_backprop_float.restype = c_int

CPSIG.sig_combine_backprop_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
CPSIG.sig_combine_backprop_double.restype = c_int

######################################################
# batch_sig_combine_backprop
######################################################

CPSIG.batch_sig_combine_backprop_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
...
CPSIG.batch_sig_combine_backprop_float.restype = c_int

CPSIG.batch_sig_combine_backprop_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
CPSIG.batch_sig_combine_backprop_double.restype = c_int
...
CPSIG.batch_sig_kernel_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    c_uint64,
    c_uint64,
...
CPSIG.batch_sig_kernel_float.restype = c_int

CPSIG.batch_sig_kernel_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    c_uint64,
    c_uint64,
...
CPSIG.batch_sig_kernel_double.restype = c_int

if BUILT_WITH_CUDA:
    CUSIG.batch_sig_kernel_cuda_float.argtypes = (
        POINTER(c_float),
        POINTER(c_float),
        c_uint64,
        c_uint64,
    ...
    CUSIG.batch_sig_kernel_cuda_float.restype = c_int

    CUSIG.batch_sig_kernel_cuda_double.argtypes = (
        POINTER(c_double),
        POINTER(c_double),
        c_uint64,
        c_uint64,
    ...
    CUSIG.batch_sig_kernel_cuda_double.restype = c_int

######################################################
# batch_sig_kernel_backprop
######################################################

CPSIG.batch_sig_kernel_backprop_float.argtypes = (
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
    POINTER(c_float),
...
CPSIG.batch_sig_kernel_backprop_float.restype = c_int

CPSIG.batch_sig_kernel_backprop_double.argtypes = (
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
    POINTER(c_double),
...
CPSIG.batch_sig_kernel_backprop_double.restype = c_int

if BUILT_WITH_CUDA:
    CUSIG.batch_sig_kernel_backprop_cuda_float.argtypes = (
        POINTER(c_float),
        POINTER(c_float),
        POINTER(c_float),
        POINTER(c_float),
    ...
    CUSIG.batch_sig_kernel_backprop_cuda_float.restype = c_int

    CUSIG.batch_sig_kernel_backprop_cuda_double.argtypes = (
        POINTER(c_double),
        POINTER(c_double),
        POINTER(c_double),
        POINTER(c_double),
    ...
    CUSIG.batch_sig_kernel_backprop_cuda_double.restype = c_int
